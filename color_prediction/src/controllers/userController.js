...
const aviator = async (req, res) => {
   let auth = req.cookies.auth
   res.redirect(`http://aviator.xhost.co.in/`)
}
   ...
   if (data) {
      if (data == 1) {
         ...
         if (check >= data && point_list.total1 != 0) {
            ...
            try {
               await balanceHelper.updateBalanceInMainWallet(rows[0].phone, point_list.total1, '+','phone');
            } catch (error) {
      ...
      if (data == 2) {
         ...
         if (check >= get && point_list.total2 != 0) {
            ...
            try {
               await balanceHelper.updateBalanceInMainWallet(rows[0].phone, point_list.total2, '+','phone');
            } catch (error) {
      ...
      if (data == 3) {
         ...
         if (check >= get && point_list.total3 != 0) {
            ...
            try {
               await balanceHelper.updateBalanceInMainWallet(rows[0].phone, point_list.total3, '+','phone');
            } catch (error) {
      ...
      if (data == 4) {
         ...
         if (check >= get && point_list.total4 != 0) {
            ...
            try {
               await balanceHelper.updateBalanceInMainWallet(rows[0].phone, point_list.total4, '+','phone');
            } catch (error) {
      ...
      if (data == 5) {
         ...
         if (check >= get && point_list.total5 != 0) {
            ...
            try {
               await balanceHelper.updateBalanceInMainWallet(rows[0].phone, point_list.total5, '+','phone');
            } catch (error) {
      ...
      if (data == 6) {
         ...
         if (check >= get && point_list.total6 != 0) {
            ...
            try {
               await balanceHelper.updateBalanceInMainWallet(rows[0].phone, point_list.total6, '+','phone');
            } catch (error) {
      ...
      if (data == 7) {
         ...
         if (check >= get && point_list.total7 != 0) {
            ...
            try {
               await balanceHelper.updateBalanceInMainWallet(rows[0].phone, point_list.total7, '+','phone');
            } catch (error) {
         ...
         if (userInfo.money - money >= 0) {
            if (result == 0) {
               if (total - total2 >= 0) {
                  ...
                  try {
                     await balanceHelper.updateBalanceInMainWallet(userInfo.phone, money, '-','phone');
                  } catch (error) {
...
const useRedenvelope = async (req, res) => {
   ...
   if (redenvelopes.length == 0) {
      ...
      if (infoRe.status == 0) {
         ...
         try {
            await balanceHelper.updateBalanceInMainWallet(userInfo.phone, infoRe.money, '+','phone');
         } catch (error) {
...
const callback_bank = async (req, res) => {
   ...
   if (status == 2) {
      ...
      try {
         await balanceHelper.updateBalanceInMainWallet(info[0].phone, info[0].money, '+','phone');
      } catch (error) {
      ...
      try {
         ...
         if (apiRecord.client_txn_id === rechargeData.id_order && apiRecord.customer_mobile === rechargeData.phone && apiRecord.amount === rechargeData.money) {
            if (apiRecord.status === "success") {
               ...
               try {
                  await balanceHelper.updateBalanceInMainWallet(apiRecord.customer_mobile, money, '+','phone');
               } catch (error) {
