                            ...
                            <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                ...
                                <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                    ...
                                    <div data-v-a9660e98="">
                                        ...
                                        <div data-v-a9660e98="" style="display: inline-block; margin-left: 8px;">${list_orders.result == 0 ? "Purple" : list_orders.result == 5 ? "Indigo" : list_orders.result % 2 == 0 ? "Red" : "Green"}</div>
                                ...
                                <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                    ...
                                    <div data-v-a9660e98="" class="${list_orders.status == 1 ? "green" : list_orders.status == 2 ? "red" : ""}">${list_orders.status == 1 ? "Success" : list_orders.status == 2 ? "Failure" : ""}</div>
                                </div>
                                <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
