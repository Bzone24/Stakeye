...
var startupdown = 0;
var imgTag;
var crashTimeout; // New variable for crash timeout
...
function setVariable(is_plan = '') {
    ...
    // Randomize duration between 28,000 ms (28s) and 30,000 ms (30s)
    // const gameDuration = Math.random() * (30000 - 30000) + 28000;
    const gameDuration = Math.random() * 30000;
...
function animatePathDrawing(ctx, x0, y0, x1, y1, x2, y2, duration, imgTag) {
    var step = function animatePathDrawingStep(timestamp) {
        ...
        var deltaTime = timestamp - lastTimestamp; // Calculate time since last frame
        lastTimestamp = timestamp;
        
        // Calculate progress based on deltaTime
