...
$('#loginForm').validate({
    ...
    submitHandler: function(form) {
        ...
        login_ajax($(form).serialize(), website_url+"/dashboard");
    }
});
...
$("#forgotPasswordForm").on('submit', function(e) {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $("#user_name_div").hide();
            $("#otp_div").show(); // Show the OTP input
        ...
        error: function(xhr, status, error) {
            ...
            $("#processSubmit").prop('disabled', false);
            $(".email_text").text('An error occurred during the request.');
            $(".email_text").css("color", "#FF0000");
        }
    });
});
        ...
        $.ajax({
            ...
            success : function(result) {
                ...
                if(result.isSuccess) {
                    ...
                    $("#reset_username").val(result.data.mobile);
                    $("#otp_error").hide();
                } else {
                    $("#otp").prop('disabled', false);
...
$('#resetPasswordForm').validate({
    ...
    submitHandler: function(form) {
        ...
        $.ajax({
            url: website_url+'/reset_password',
            data : $(form).serialize(),
            type: "POST",
            success: function(result) {
                if (result.isSuccess) {
                    ...
                    login_ajax(data, website_url+'/dashboard')
                } else {
