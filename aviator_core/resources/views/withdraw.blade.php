    ...
    <div class="deposite-container">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="pay-tabs">
                        <a href="{{ url('deposit') }}" class="custom-tabs-link">DEPOSIT</a>
                ...
                <div class="modal-body pt-1">
                    <form class="login-form text-center" action="/insert/withdrawal" method="post" id="withdraw_form">
                        ...
                        <div id="amount_div">
                            ...
                            <label for="amount" class="form-label text-secondary">Available Balance :
                                {{ wallet(user('id')) }}</label>
                            <input type="hidden" name="wallet_balance" id="balance"
                                value="{{ wallet(user('id'), 'num') }}">
                        </div>
                        ...
                        <div id="account_div">
                            ...
                            <div class="login-controls">
                                <label for="account_no">
                                    <input type="text" class="form-control text-indent-0" id=""
                                        name="account_no" value="{{ $bank->accountno ?? '' }}">
                                </label>
                            </div>
                        ...
                        <div id="acc_holder_name_div">
                            ...
                            <div class="login-controls">
                                <label for="account_holder_name">
                                    <input type="text" class="form-control text-indent-0" name="account_holder_name"
                                        value="{{ user('name') }}">
                                </label>
                            </div>
                        ...
                        <div id="">
                            ...
                            <div class="login-controls">
                                <label for="bankname">
                                    <input type="text" class="form-control text-indent-0" name="bank_name" required
                                        value="{{ $bank->bankname ?? '' }}">
                                </label>
                            </div>
                        ...
                        <div id="ifsc_code_div">
                            ...
                            <div class="login-controls">
                                <label for="ifsc_code">
                                    <input type="text" class="form-control text-indent-0" name="ifsc_code"
                                        value="{{ $bank->ifsccode ?? '' }}">
                                </label>
                            </div>
                        ...
                        <div id="upi_id_div">
                            ...
                            <div class="login-controls">
                                <label for="upi_id">
                                    <input type="text" class="form-control text-indent-0" name="upi_id"
                                        value="{{ $bank->upi_id ?? '' }}">
                                </label>
                            </div>
                        ...
                        <div id="mobile_div">
                            ...
                            <div class="login-controls">
                                <label for="mobile_no">
                                    <input type="text" class="form-control text-indent-0" name="mobile_no"
...
@section('js')
    ...
    @isset($_GET['msg'])
        ...
        @endif
        @if ($_GET['msg'] == 'min_amount' )
            <script>
                toastr.error("Please Enter Minimum Amount ");
            </script>
        @endif
        @if ($_GET['msg'] == 'min_time' )
            <script>
                toastr.error("Enter Amount On Minimum And Maximum Time ");
            </script>
        @endif
    @endisset
@endsection
