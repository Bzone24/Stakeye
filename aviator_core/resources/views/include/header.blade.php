...
<header>
    <div class="header-top">
        ...
        <?php  synwalletbalancefrommain(user('id') );?>
            ...
            <a href="{{$mainSiteUrl}}/user/dashboard" class=" btn btn-danger">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark profile-dropdown p-0">
                        ...
                        <li>
                            <a href="{{ url('crash') }}" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <img src="{{url('images/logo.svg')}}" class="side_logo">
                                </div>
                            </a>
                        </li>
                        ...
                        <?php /*<li>
                            <a href="{{ url('deposit') }}" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        payments
                                    </span>DEPOSIT FUNDS
                        ...
                        <li>
                            <a href="{{ url('withdraw') }}" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        payments
                        ...
                        <li>
                            <a href="{{ url('amount-transfer') }}" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        payments
                        ...
                        <li>
                            <a href="{{ url('profile') }}" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        account_circle
                        ...
                        <li>
                            <a href="{{ url('deposit_withdrawals') }}" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        payments
                        ...
                        <li>
                            <a href="{{ url('level-management') }}" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        payments
                        ...
                        <?php /*   <li>
                            <a href="{{ url('referal') }}" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        payments
                                    </span>REFERRAL
                        ...
                        <li>
                            <a href="{{$mainSiteUrl}}/user/dashboard" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        payments
                                    </span>Return to Main
        ...
        @else
            <div class="header-right d-flex align-items-center">
            <a href="{{$mainSiteUrl}}/user/login" class=" btn btn-danger">
                <i class="fa fa-lock"></i>&nbsp;
                Login
            </a>
            &nbsp;
            &nbsp;
            <a href="{{$mainSiteUrl}}/user/register" class=" btn btn-info">
                <i class="fa fa-user"></i>&nbsp;
                Signup 
            </a>


           <?php /*     <button class="register-btn rounded-pill d-flex align-items-center me-2 reg_btn" data-bs-toggle="modal"
