 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
     <ul class="nav">
         <li class="nav-item nav-profile">
             <a href="#" class="nav-link">
                 <div class="nav-profile-image">
                     <img src="{{url('/aviatoradmin/assets/images/faces/face1.jpg')}}" alt="profile">
         ...
         <li class="nav-item">
             <a class="nav-link" href="{{route('rechargehistory')}}">
                 <span class="menu-title">Recharge history</span>
                 <i class="mdi mdi-wallet-plus menu-icon"></i>
             </a>
         </li>
         <li class="nav-item">
             <a class="nav-link" href="{{route('withdrawhistory')}}">
                 <span class="menu-title">Withdrawal history</span>
                 <i class="mdi mdi-wallet-bifold menu-icon"></i>
             </a>
         </li>
         <li class="nav-item">
             <a class="nav-link" href="{{route('amount-setup')}}">
                 <span class="menu-title">Amount Setup</span>
                 <i class="mdi mdi-cash-multiple menu-icon"></i>
             </a>
         </li>
         <li class="nav-item">
             <a class="nav-link" href="{{route('gameresult')}}">
                 <span class="menu-title">Game Result</span>
                 <i class="mdi mdi-cash-multiple menu-icon"></i>
             </a>
         </li>
         <li class="nav-item">
             <a class="nav-link" href="{{route('bankdetails')}}">
