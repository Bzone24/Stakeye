...
<body class="dark-bg-main">
                    ...
                    <form class="login-form" method="post" action="#" name="loginForm" id="loginForm">
                        ...
                        <div class="login-controls">
                            <label for="Username">
                                ...
                                <input type="text" class="form-control" id="username" name="username" placeholder="Your email/phone">
                            </label>
                        </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="via-email" role="tabpanel"
                                ...
                                <form class="register-form row" action="/auth/register" method="post"
                                    ...
                                    <!-- Hidden OTP Input Box -->
                                    <div class="col-12" id="otpDiv" style="display: none;">
                                        <div class="input-group flex-nowrap mb-3 promocode align-items-center">
                                            <span class="input-group-text" id="addon-wrapping">
                                                <span class="material-symbols-outlined bold-icon">
                                                    key
                                            ...
                                            <input type="number" class="form-control ps-0" id="otpInput"
                                    ...
                                    <div class="col-12">
                                        <div class="input-group flex-nowrap mb-3 promocode align-items-center">
                                            ...
                                            <input type="text" class="form-control ps-0" id="promo_code"
                                                name="promocode" placeholder="Enter Referral Code"
                                                value="{{ isset($_GET['refer']) ? $_GET['refer'] : '' }}">
                                    ...
                                    <button type="submit" class="btn orange-btn md-btn custm-btn-2 mx-auto mt-3 mb-0 registerSubmit" id="register_via_email">START GAME</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{url('unpkg.com/sweetalert%402.1.2/dist/sweetalert.min.js')}}"></script>
    ...
    <script>
        ...
        $('#mobile').on('input', function() {
                ...
                // If the length is 10, enable the button. Otherwise, disable it.
            ...
            $('#sendOtpBtn').click(function() {
                ...
                // On success of the AJAX call, display the OTP input box
                $('#otpDiv').show();
            });
    </script>
    <script>
    ...
    <script src="{{url('user/login.js')}}"></script>
    @yield('js')
</body>
