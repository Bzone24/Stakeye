...
@section('content')
    <div class="active" id="via-email">
        <form class="register-form row w-75" style="margin: 100px auto 0 auto; color: white !important;"
            action="/auth/register" method="post" name="registerForm" id="registerViaEmailForm">
            <h2>Register</h2>
            ...
            <div class="col-12" id="otpDiv" style="display: none;">
                <div class="input-group flex-nowrap mb-3 promocode align-items-center">
                    ...
                    <input type="number" class="form-control ps-0" id="otpInput" placeholder="Enter OTP" name="otp">
                </div>
            </div>
            <div class="col-12">
                <div class="input-group flex-nowrap mb-3 promocode align-items-center">
            ...
            <div class="col-12">
                <div class="input-group flex-nowrap mb-3 promocode align-items-center">
                    ...
                    <input type="text" class="form-control ps-0" id="promo_code" name="promocode"
                        placeholder="Enter Promocode" value="{{ isset($_GET['refer']) ? $_GET['refer'] : '' }}"
                        {{ isset($_GET['refer']) ? 'readonly' : '' }}>
