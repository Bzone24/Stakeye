                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <label for="sports_id">@lang('Sports Id')</label>
                                <input type="number" class="form-control checkSlug" id="sports_id" name="sports_id"
                                    value="{{ old('sports_id') }}" required min="1" step="1" placeholder="@lang('Enter Sports ID')">
                                <small class="text-muted">@lang('Sports ID should be an integer only')</small>
                            </div>
