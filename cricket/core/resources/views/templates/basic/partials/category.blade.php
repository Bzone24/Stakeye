...
<nav class="sports-category" data-simplebar>
    <div class="sports-category__list">
        @foreach ($categories as $category)
            <a class="sports-category__link @if (@$activeCategory->id == $category->id) active @endif"
                href="{{ route('category.games', $category->slug) }}">
...
<nav class="sports-sub-category" data-simplebar>
    <div class="sports-category__list">
        @foreach ($leagues as $league)
            <a class="sub-category-drawer__link @if (@$activeLeague->id == $league->id) active @endif"
                href="{{ route('league.games', $league->slug) }}">
                <span class="sub-category-drawer__flag d-none">
                    <img class="sub-category-drawer__flag-img"
                        ...
                        @foreach ($leagues as $league)
                            <li>
                                <a class="sub-category-drawer__link @if (@$activeLeague->id == $league->id) active @endif"
                                    ...
                                    <span class="sub-category-drawer__text" title="{{ __($league->name) }}" style="color: hsl(var(--base)) !important;">
                                        {{ __($league->short_name) }}
                                    </span>
                                </a>
