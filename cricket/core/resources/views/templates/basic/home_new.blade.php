                ...
                <div class="sports-card position-relative">
                    <span class="sports-card__head">
                        <span class="sports-card__team">
                            <span class="sports-card__team-flag d-none">
                                <img class="sports-card__team-flag-img"
                                    src="https://stakeye.com/cricket/assets/images/team/67c6fa5c84b6a1741093468.jpg"
                                    alt="@lang('image')">
                            </span>
                        ...
                        <span class="sports-card__info text-center">
                            ...
                            <span class="sports-card__info-time">{{ carbonParse($match->openDate, 'd M, h:i') }}</span>
                        </span>
                        @endif
                        ...
                        <span class="sports-card__team">
                            <span class="sports-card__team-flag d-none">
                                <img class="sports-card__team-flag-img"
                                    src="https://stakeye.com/cricket/assets/images/team/67c7dd0677bce1741151494.png"
                                    alt="@lang('image')">
                            </span>
                            <span class="sports-card__team-name">
                                {{$match->team2}}
                    ...
                    <div class="custom-dropdown">
                        <div class="d-flex justify-content-between">
                            <span class="custom-dropdown-selected">@lang('Markets')</span>
                            <a href="{{ route('game.markets', $match->slug) }}" class="text--small">@lang('View All Markets')</a>
                        </div>
                        <div class="custom-dropdown-list">
                            @foreach ($match->markets as $market)
                            <div class="custom-dropdown-list-item"
                                data-reference="{{ $market->id }}">{{ $market->marketName }}</div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="option-odd-list">
                        ...
                        <div class="option-odd-list__item">
                            <div>
                                @php
                                $oddValue = number_format(mt_rand(100, 200) / 100, 2);
                                $spanValue = number_format(mt_rand(100, 200) / 100, 2);
                                @endphp
                                <button class="btn btn-sm btn-light text--small border oddBtn">{{ $oddValue }}</button>
                                <span class="text--extra-small d-block text-center">{{ $spanValue }}</span>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    @else
                    <p class="text-center text-muted">@lang('No markets available')</p>
                    @endif
