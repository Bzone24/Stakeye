...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('LeagueController')->name('league.')->prefix('leagues')->group(function () {
        ...
        Route::post('status/{id}', 'status')->name('status');
        Route::post('flag/{id}', 'flag')->name('flag');
        Route::get('/fetch-league', 'fetchLeague')->name('fetch');
    });
    ...
    Route::controller('TeamController')->name('team.')->prefix('teams')->group(function () {
        ...
        Route::get('/list', 'list')->name('list');
        Route::post('store/{id?}', 'store')->name('store');
        Route::get('/fetch-team', 'fetchTeam')->name('fetch');
    });
    ...
    Route::controller('GameController')->name('game.')->prefix('games')->group(function () {
        ...
        Route::get('/fetch-game', 'fetchLiveGame')->name('fetch');
        Route::get('/fetch-upcoming-game', 'fetchGameMarket')->name('market');
    });
