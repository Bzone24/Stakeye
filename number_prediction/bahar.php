...
<form action="bahar_check.php" method="POST" name="single_frm">
...
echo "<option disabled value='bahar-$id'>$name ($time1)</option>";	
}else{
echo "<option value='bahar-$id'>$name ($time1)</option>";	
}
}
?>
</select>
