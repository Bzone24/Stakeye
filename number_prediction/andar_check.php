...
if($zero=="" && $one=="" && $two=="" && $three=="" && $four=="" && $five=="" && $six=="" && $seven=="" && $eight=="" && $nine==""){
	header("location: andar.php?$date=$date&msg=Bet on atleast one number");
}else{
	$check_id="";
	if($open_close=="open"){
	...
	if(($check_id!="" && $date==$check_date) || $date > $check_date){
		...
		$balance=$wallet;
		if(!empty($zero)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$zero','$id','$open_close','0','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($one)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$one','$id','$open_close','1','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($two)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$two','$id','$open_close','2','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($three)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$three','$id','$open_close','3','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($four)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$four','$id','$open_close','4','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($five)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$five','$id','$open_close','5','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($six)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$six','$id','$open_close','6','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($seven)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$seven','$id','$open_close','7','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($eight)){
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$eight','$id','$open_close','8','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		if(!empty($nine))
		{		
		$stmt1 = "insert into BET_TRANSACTIONS (USER_ID,DATE_TIME,AMOUNT,GAME_ID,GAME,NUMBER,STATUS,RESULT,RAND,DATE,TYPE) values ('$user_id',now(),'$nine','$id','$open_close','9','','','$rand','$date','Andar');";
		$db->query($stmt1);
		...
		header("location: andar.php?success=Bet Accepted");
	}else{
		header("location: andar.php?msg=You are late for this bet");
	}
}
}else{
	header("location: andar.php?msg=Low Balance");
}
}else{
