...
$stmt2 = $db->query("select ID, WIN_AMOUNT, USER_ID, RESULT from BET_TRANSACTIONS where GAME_ID='37' and DATE=CURDATE() and GAME='$time' and STATUS!='DELETED';");
...
header("location: result3.php?hour=$time");
?>
