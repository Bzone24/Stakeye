...
<form action="starline_patti_check.php" method="POST" name="single_patti_frm" id="single_patti_frm">
<h2>STARLINE SINGLE PATTI (10 KA <?php echo $starline_patti_price;?>)</h2>
