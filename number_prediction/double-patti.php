...
<form action="double_patti_check.php" method="POST" name="double_patti_frm" id="double_patti_frm">
<h2>DOUBLE PATTI (10 KA <?php echo $d_patti_price;?>)</h2>
...
$check_id="";
if($id=="1400000000000000000000000"){
