...
$stmt1 = "insert into TRANSACTIONS(USER_ID,DATE_TIME,AMOUNT,BALANCE,REMARK) values ('$user_id1',now(),'$amount','$balance','Added');";
$db->query($stmt1);
$stmt1 = "update PAYMENT_QUEUE set STATUS='COMPLETED' where ID='$id' and IMAGE='$rand' and USER_ID='$user_id' and STATUS is NULL;;";
$db->query($stmt1);
}
		}
		$txn_data = $result['data'];
